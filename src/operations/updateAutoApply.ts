...
export const UpdateAutoApplyInput = Schema.Struct({
  ...
  [ApiPath]: (input: { organization: string; database: string; number: string }) =>
    `/organizations/${input.organization}/databases/${input.database}/deploy-requests/${input.number}/auto-apply`,
...
export const updateAutoApply = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  ...
  errors: [UpdateAutoApplyUnauthorized, UpdateAutoApplyForbidden, UpdateAutoApplyNotfound],
}));
