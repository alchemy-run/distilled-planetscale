...
export const WorkflowCutoverInput = Schema.Struct({
  ...
  [ApiPath]: (input: { organization: string; database: string; number: string }) =>
    `/organizations/${input.organization}/databases/${input.database}/workflows/${input.number}/cutover`,
...
export const workflowCutover = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  ...
  errors: [WorkflowCutoverUnauthorized, WorkflowCutoverForbidden, WorkflowCutoverNotfound],
}));
