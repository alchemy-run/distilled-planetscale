...
export const GetDeployRequestInput = Schema.Struct({
  ...
  [ApiPath]: (input: { organization: string; database: string; number: string }) =>
    `/organizations/${input.organization}/databases/${input.database}/deploy-requests/${input.number}`,
...
export const getDeployRequest = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  ...
  errors: [GetDeployRequestUnauthorized, GetDeployRequestForbidden, GetDeployRequestNotfound],
}));
