...
export const GetOrganizationOutput = Schema.Struct({
  ...
  has_past_due_invoices: Schema.optionalWith(Schema.Boolean, { default: () => false }),
  database_count: Schema.Number,
  sso_portal_url: Schema.optionalWith(Schema.String, { default: () => "" }),
  features: Schema.Unknown,
  idp_managed_roles: Schema.Boolean,
  invoice_budget_amount: Schema.NumberFromString,
