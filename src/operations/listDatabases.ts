...
export const ListDatabasesOutput = Schema.Struct({
  ...
  data: Schema.Array(Schema.Struct({
    ...
    data_import: Schema.NullOr(Schema.Struct({
      state: Schema.String,
    ...
    automatic_migrations: Schema.NullOr(Schema.Boolean),
    ...
    migration_table_name: Schema.NullOr(Schema.String),
    migration_framework: Schema.NullOr(Schema.String),
