...
export const CompleteRevertInput = Schema.Struct({
  ...
  [ApiPath]: (input: { organization: string; database: string; number: string }) =>
    `/organizations/${input.organization}/databases/${input.database}/deploy-requests/${input.number}/revert`,
...
export const completeRevert = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  ...
  errors: [CompleteRevertUnauthorized, CompleteRevertForbidden, CompleteRevertNotfound],
}));
