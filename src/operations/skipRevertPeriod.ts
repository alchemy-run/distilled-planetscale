...
export const SkipRevertPeriodInput = Schema.Struct({
  ...
  [ApiPath]: (input: { organization: string; database: string; number: string }) =>
    `/organizations/${input.organization}/databases/${input.database}/deploy-requests/${input.number}/skip-revert`,
...
export const skipRevertPeriod = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  ...
  errors: [SkipRevertPeriodUnauthorized, SkipRevertPeriodForbidden, SkipRevertPeriodNotfound],
}));
