...
withMainLayer("deleteBouncer", (it) => {
  ...
  it.effect(
    "should return DeleteBouncerNotfound or DeleteBouncerForbidden for non-existent organization",
    () =>
      Effect.gen(function* () {
        ...
        const isExpectedError =
          result instanceof DeleteBouncerNotfound || result instanceof DeleteBouncerForbidden;
        expect(isExpectedError).toBe(true);
      }),
  );

  it.effect(
    "should return DeleteBouncerNotfound or DeleteBouncerForbidden for non-existent database",
    () =>
      Effect.gen(function* () {
  ...
  it.effect(
    "should return DeleteBouncerNotfound or DeleteBouncerForbidden for non-existent branch",
    () =>
      Effect.gen(function* () {
        const { organization } = yield* Credentials;
  ...
  it.effect(
    "should return DeleteBouncerNotfound or DeleteBouncerForbidden for non-existent bouncer",
    () =>
      Effect.gen(function* () {
        const { organization } = yield* Credentials;
        // Use a test database name - adjust based on your PlanetScale setup
